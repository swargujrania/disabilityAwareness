...
d3.csv("pre-processing/temp2018.csv").then(d2018 => {

    d3.csv("pre-processing/2012.csv").then(d2010 => {

        d2018.forEach(a => {
            var x = d2010.find(b => b["State"].toLowerCase() == a.State.toLowerCase());
            a.Total = +x.Total;
        })
        ...
        d2010 = d2018;
        rows = ConvertToCSV(JSON.stringify(d2018));
        ...
        link.setAttribute("download", "temp2016.csv");
